...
function khoiTaoDatePickerTimKiem() {
    ...
    var popupHTML = `
        <div class="hop-lich" id="hopLichTim" style="display: none; top: 100%; left: 0; margin-top: 10px; width: 700px;">
            <div class="khung-lich">
                <button type="button" class="dieu-huong-thang" id="thangTruocTim">
